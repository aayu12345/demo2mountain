...
export default function BookingWidget() {
    ...
    return (
        ...
        >
            <div className="max-w-5xl mx-auto backdrop-blur-xl bg-black/40 border border-white/10 rounded-full shadow-2xl p-2 flex flex-col md:flex-row gap-2 ring-1 ring-white/5">
                {/* Check In */}
                <div className="flex-1 relative group px-6 py-3 hover:bg-white/5 rounded-full transition-colors cursor-pointer border-r border-white/10">
                ...
                {/* Guests */}
                <div className="flex-1 relative group px-6 py-3 hover:bg-white/5 rounded-full transition-colors cursor-pointer">
                ...
                {/* Search Button */}
                <button className="bg-emerald-600 hover:bg-emerald-500 text-white rounded-full px-8 py-3 md:py-0 font-bold flex items-center justify-center gap-2 transition-all shadow-lg hover:shadow-emerald-500/30 active:scale-95 min-w-[160px]">
                    <Search size={18} />
                    <span>Search</span>
                </button>
            </div>
